...
import (
	...
	"github.com/yangchenxing/cangshan/iplocater/ipip.net2"
	_ "github.com/yangchenxing/cangshan/iplocater/logging"
...
var (
	...
	dataSetCapacity = flag.Int("capacity", 3, "ipip.net data set capacity")
)
